...
public class FearEffectButton extends EffectsButtons{

	public FearEffectButton() {
		super(new Image("resources\\Effects\\fear.png"));
	...
	public void clickEvent(MouseEvent e) {
		if(getTarget().contains(e.getX(), e.getY())) {
			if(!isActivity()) {
				...
				int inteligenceA = (int) (championReceiver.getInteligence() * (0.1 + 0.1 * Math.random()));
				
				int played = (int)(3 * Math.random());
				
				setEffect(new Speed(0,0,0,0,0,0,-inteligenceA,played));
