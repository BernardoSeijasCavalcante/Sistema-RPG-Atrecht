...
public class CureEffectButton extends EffectsButtons{

	public CureEffectButton() {
		super(new Image("resources\\Effects\\cure.png"));
	...
	public void clickEvent(MouseEvent e) {
		if(getTarget().contains(e.getX(), e.getY())) {
			if(!isActivity()) {
				...
				int life = (int)(championReceiver.getCharacter().getLife() * (0.025 * Math.random() + 0.025));
				...
				setEffect(new Cure(life,0,0,0,0,0,0,played));
