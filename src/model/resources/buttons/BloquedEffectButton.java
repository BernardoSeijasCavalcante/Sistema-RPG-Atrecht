...
public class BloquedEffectButton extends EffectsButtons{

	public BloquedEffectButton() {
		super(new Image("resources\\Effects\\bloqued.png"));
	...
	public void clickEvent(MouseEvent e) {
		if(getTarget().contains(e.getX(), e.getY())) {
			if(!isActivity()) {
				...
				setEffect(new Bloqued(0,0,0,0,0,0,0,played));
