...
import model.resources.effects.Slowness;

public class SlownessEffectButton extends EffectsButtons{

	public SlownessEffectButton() {
		super(new Image("resources\\Effects\\slowness.png"));
	...
	public void clickEvent(MouseEvent e) {
		if(getTarget().contains(e.getX(), e.getY())) {
			if(!isActivity()) {
				...
				setEffect(new Slowness(0,0,0,0,-vdmA,0,0,played));
